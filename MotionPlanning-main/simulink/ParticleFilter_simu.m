classdef ParticleFilter_simu < handle
...
%% PF Functions
    methods
        function self = ParticleFilter_simu(N,x_range,y_range,exp_rate,alt_std,imu_std,dt)
            % Defining properties
            self.N = N;
    ...
    methods
        ...
        function find_elev_particles_pc(self,radar_data,dted)
            ...
            for i=1:self.N
                ...
                self.elev_particles_pc(i,:) = interpn(dted{1},dted{2},dted{3},particle_pc_pos(:,1),particle_pc_pos(:,2));
            end
