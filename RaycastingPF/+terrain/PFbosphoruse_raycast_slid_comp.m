...
while simTime < Tf
    ...
    p1 = plot3(particles_lla_ray(:,2),particles_lla_ray(:,1),particles_lla_ray(:,3),'r.',MarkerSize=15);
    p2 = plot3(particles_lla_slid(:,2),particles_lla_slid(:,1),particles_lla_slid(:,3),'b.',MarkerSize=15);
    p3 = plot3(TracePose_lla(:,2),TracePose_lla(:,1),TracePose_lla(:,3),'g*',MarkerSize=15);
    ...
    particle_pt_p_ray = plot3(particle_pt_lla_ray(:,2),particle_pt_lla_ray(:,1),particle_pt_lla_ray(:,3),'mo');
    particle_pt_p_slid = plot3(particle_pt_lla_slid(:,2),particle_pt_lla_slid(:,1),particle_pt_lla_slid(:,3),'k+');
    hold off;
    %p1.MarkerSize = 2;
    %p2.MarkerSize = 2;
    
    legend({'DTED Mesh','Raycast-MF-Part','Slid-MF-Part','True Pos','PcRadar','PcRay','PcSlid'},Location="best")
