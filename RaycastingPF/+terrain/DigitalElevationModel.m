classdef DigitalElevationModel < handle
    ...
    methods
        ...
        function [dted,x,y,z] = getMetricGridElevationMap(obj,...
            ...
            xf = terrain.DigitalElevationModel.sphericalDistance([lats(1) lons(1)],[lats(1) lons(end)]);
            yf = terrain.DigitalElevationModel.sphericalDistance([lats(1) lons(1)],[lats(end) lons(1)]);
