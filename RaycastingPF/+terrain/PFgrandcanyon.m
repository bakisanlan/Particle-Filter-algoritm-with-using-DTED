...
alt_std = 10;
raycast_flag = false;
hEstimator_ray = terrain.StateEstimatorPF(N,hAircraft.Pose,range_part,range_part,0,alt_std,Ts);
hEstimator_ray.hReferenceMapScanner = hReferenceMapScanner;

hEstimator_slid = terrain.StateEstimatorPF(N,hAircraft.Pose,range_part,range_part,0,alt_std,Ts);
